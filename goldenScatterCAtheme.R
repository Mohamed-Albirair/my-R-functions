# My ggplot theme for a "golden scatterplot" Christopher Adolph (with help from Brian Leung)
...
goldenScatterCAtheme <- theme(
      ...
      axis.title.x       = element_text(size = 12, margin = margin(t = 7.5, r = 0, b = 0, l = 0)),
      ...
      axis.title.y       = element_text(size = 12, margin = margin(t = 0, r = 7.5, b = 0, l = 0)),
      ## match type of axis labels and titles, pad
